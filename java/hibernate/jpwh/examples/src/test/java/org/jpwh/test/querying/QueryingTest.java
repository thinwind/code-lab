...
public class QueryingTest extends JPATest {
    ...
    public void configurePersistenceUnit() throws Exception {
        configurePersistenceUnit("QueryingPU", "querying/ExternalizedQueries.hbm.xml",
                "querying/SQLQueries.hbm.xml", "querying/StoredProcedures.hbm.xml");
    }
    ...
    @Test
    public void testMoreRestriction() throws Exception {
        storeTestData();
        UserTransaction tx = TM.getUserTransaction();
        tx.begin();
        EntityManager em = JPA.createEntityManager();

        Query query = em.createNamedQuery("outerFetchMultipleWithMoreRestriction");
